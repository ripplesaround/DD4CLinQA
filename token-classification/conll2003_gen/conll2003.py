...
_URL = "/home/fwx/local_datasets/CONLL2003/"
...
class Conll2003(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        Conll2003Config(name="conll2003_gen", version=datasets.Version("1.0.0"), description="Conll2003 dataset"),
    ]
        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for line in f:
                if line.startswith("-DOCSTART-") or line == "" or line == "\n":
                    ...
                    # conll2003_gen tokens are space separated
                    splits = line.split(" ")
